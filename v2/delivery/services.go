...
func NewClient(key, secret string) *binance.Client {
	return binance.NewDeliveryClient(key, secret)
}

func NewTestClient(key, secret string) *binance.Client {
	return binance.NewDeliveryTestClient(key, secret)
}
...
func NewGetBalanceService(c *binance.Client) *GetBalanceService {
...
func NewListLiquidationOrdersService(c *binance.Client) *ListLiquidationOrdersService {
