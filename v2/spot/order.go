...
func (s *CreateOrderService) createOrder(ctx context.Context, endpoint string, opts ...binance.RequestOption) (resData []byte, err *binance.APIError) {
	r := &binance.Request{
		Method:   "POST",
		Endpoint: endpoint,
...
// Do send request
func (s *CreateOrderService) Do(ctx context.Context) (res *CreateOrderResponse, err *binance.APIError) {
	data, rErr := s.createOrder(ctx, "/api/v3/order")
	if rErr != nil {
		return nil, rErr
	}
...
func (s *CreateOrderService) Test(ctx context.Context) (err *binance.APIError) {
	_, err = s.createOrder(ctx, "/api/v3/order/test")
	return err
}
...
func (s *CreateOCOService) createOrder(ctx context.Context, endpoint string, opts ...binance.RequestOption) (resData []byte, err *binance.APIError) {
	r := &binance.Request{
		Method:   "POST",
		Endpoint: endpoint,
		SecType:  binance.SecTypeSigned,
...
// Do send request
func (s *CancelOCOService) Do(ctx context.Context, opts ...binance.RequestOption) (res *CancelOCOResponse, err *binance.APIError) {
	r := &binance.Request{
		Method:   "DELETE",
...
func (s *CancelOpenOrdersService) Do(ctx context.Context, opts ...binance.RequestOption) (res *CancelOpenOrdersResponse, err error) {
	...
	jErr := json.Unmarshal(data, &rawMessages)
	if jErr != nil {
		return nil, binance.NewApiErr(jErr.Error())
	}
	...
	for _, j := range rawMessages {
		...
		if jErr := json.Unmarshal(*j, o); jErr != nil {
			return &CancelOpenOrdersResponse{}, binance.NewApiErr(jErr.Error())
		}
		...
		if jErr := json.Unmarshal(*j, oco); jErr != nil {
			return &CancelOpenOrdersResponse{}, binance.NewApiErr(jErr.Error())
		}
